...
@Component({
    ...
    template: `
        <div class="githubuser">
            ...
            <p>This application illustates an enhanced <strong>Profile</strong> and <strong>Dashboard</strong> page for Github users. This application uses an <i>in-memory</i> database to store additional profile and dashboard metrics. No data gets posted (or updated) to your public github page.</p>
